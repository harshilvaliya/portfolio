...
//     <section
//       id="projects"
//       className="min-h-screen bg-[#1C1C1A] text-[#E6E6E1] p-12"
//     >
        ...
        <div className="w-full max-w-6xl">
          <h1 className="text-3xl sm:text-4xl font-bold mb-2">
            ...
            <span className="font-extralight">
              <FolderGit2 className="inline-block ml-2" />
            </span>
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            {projects.map((project) => (
              ...
              >
                ...
                <p className="text-sm text-[#e6e6e16d] mb-4">
                  {project.description}
                </p>
                ...
                <div className="flex gap-2 text-sm">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center text-[#E6E6E1] hover:text-[#E6E6E1]/80 px-3 py-1.5 rounded-full bg-[#1C1C1A] transition-colors duration-300"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center text-[#E6E6E1] hover:text-[#E6E6E1]/80 px-3 py-1.5 rounded-full bg-[#1C1C1A] transition-colors duration-300"
                  >
                    <Github className="mr-2" size={14} /> GitHub
                  </a>
                </div>
              </div>
            ))}
